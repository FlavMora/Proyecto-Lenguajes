...
--- ========================================================================
    ...
    DECLARE
      v_dummy NUMBER;
    BEGIN
      SELECT 1 INTO v_dummy FROM user_sequences WHERE sequence_name = 'SEQ_NUMERO_PEDIDO';
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        EXECUTE IMMEDIATE 'CREATE SEQUENCE seq_numero_pedido START WITH 1 INCREMENT BY 1 NOCACHE';
    END;
    /

    -- Secuencia para n̼meros de factura (crear solo si no existe)
    DECLARE
      v_dummy NUMBER;
    BEGIN
      SELECT 1 INTO v_dummy FROM user_sequences WHERE sequence_name = 'SEQ_NUMERO_FACTURA';
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        EXECUTE IMMEDIATE 'CREATE SEQUENCE seq_numero_factura START WITH 1 INCREMENT BY 1 NOCACHE';
    END;
    /
    ...
    CREATE OR REPLACE PACKAGE BODY PKG_FERRETERIA AS
        ...
        PROCEDURE sp_validar_usuarios_activos AS
            ...
            v_count NUMBER := 0;
        BEGIN
            -- Recorre los usuarios activos y los marca como inactivos
    ...
    VALUES ('admin', '$2a$12$dqlI7R99JSEZTZgrkFKjqeQMutvzs8Mh.N1EsRsVrw3y8TKF.S292', 'admin@ferreteria.com', 'Administrador', 'Sistema', 1);
    ...
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /

    BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX idx_clientes_cedula ON Clientes(cedula)';
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /
    ...
    BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX idx_productos_codigo ON Productos(codigo_producto)';
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /
    ...
    BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX idx_productos_categoria ON Productos(categoria)';
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /
    ...
    BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX idx_factura_fecha ON Factura(fecha)';
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /
    ...
    BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX idx_factura_cliente ON Factura(IdCliente)';
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /
    ...
    BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX idx_pedidos_fecha ON Pedidos(fecha)';
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /
    ...
    BEGIN
    EXECUTE IMMEDIATE 'CREATE INDEX idx_pedidos_proveedor ON Pedidos(IdProveedor)';
    EXCEPTION
    WHEN OTHERS THEN IF SQLCODE IN (-955, -1408) THEN NULL; ELSE RAISE; END IF;
    END;
    /
